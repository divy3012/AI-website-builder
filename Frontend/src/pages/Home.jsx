    ...
    <div className="relative min-h-screen bg-[#040404] text-white overflow-hidden ">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center ">
          ...
          <div className="flex items-center gap-5 ">
            <div
              className="hidden md:inline text-zinc-300 hover:text-white cursor-pointer text-sm  "
            ...
            {userData && (
              <div
                className=" hidden md:flex items-center gap-3 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-sm cursor-pointer hover:bg-white/10 transition"
                onClick={() => navigate("/pricing")}
              >
      ...
      <section className="pt-44 pb-32 px-6 text-center">
        ...
        <motion.p
          ...
          animate={{ y: 0, opacity: 1 }}
          className="mt-8 max-w-2xl mx-auto text-zinc-300 text-lg"
        >
      ...
      {!userData && (
        <section className="max-w-7xl px-6 pb-32 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {websites.slice(0, 3).map((w, i) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className=" mt-16 text-base font-semibold line-clamp-2">
                    {w.title}
                  </h3>
